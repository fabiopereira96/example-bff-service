package com.bff.example.web.rest;

import com.bff.example.domain.User;
import com.bff.example.service.InvalidPasswordException;
import com.bff.example.service.MailService;
import com.bff.example.service.UserService;
import com.bff.example.service.UsernameAlreadyUsedException;
import com.bff.example.service.dto.PasswordChangeDTO;
import com.bff.example.service.dto.UserDTO;
import com.bff.example.web.rest.errors.EmailAlreadyUsedException;
import com.bff.example.web.rest.errors.EmailNotFoundException;
import com.bff.example.web.rest.errors.LoginAlreadyUsedException;
import com.bff.example.web.rest.vm.KeyAndPasswordVM;
import com.bff.example.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.bff.example.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
