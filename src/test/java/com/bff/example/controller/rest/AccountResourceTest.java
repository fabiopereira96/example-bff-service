...
public class AccountResourceTest {
    ...
    //
    //        Optional<UserEntity> userDup = userRepository.findOneByLogin("badguy");
    ...
    public void testActivateAccount() throws Exception {
        ...
        var activatedUser = get("/api/users/{login}", user.login).then().statusCode(OK.getStatusCode()).extract().as(UserEntity.class);
    ...
    public void testSaveAccount() {
        ...
        var updatedUser = get("/api/users/{login}", user.login).then().statusCode(OK.getStatusCode()).extract().as(UserEntity.class);
