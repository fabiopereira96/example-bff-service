...
public class UserResourceTest {
    ...
    public void createUser() {
        ...
        var testUser = get("/api/users/{login}", managedUserVM.login).then().extract().body().as(UserEntity.class);
    ...
    public void updateUser() throws Exception {
        ...
        // Update the user
        var updatedUser = get("/api/users/{login}", managedUserVM.login).then().extract().body().as(UserEntity.class);
        ...
        UserEntity testUserEntity = get("/api/users/{login}", managedUserVM.login).then().extract().body().as(UserEntity.class);
        assertThat(testUserEntity.firstName).isEqualTo(UPDATED_FIRSTNAME);
        assertThat(testUserEntity.lastName).isEqualTo(UPDATED_LASTNAME);
        assertThat(testUserEntity.email).isEqualTo(UPDATED_EMAIL);
        assertThat(testUserEntity.imageUrl).isEqualTo(UPDATED_IMAGEURL);
        assertThat(testUserEntity.langKey).isEqualTo(UPDATED_LANGKEY);
    }
    ...
    public void updateUserLogin() throws Exception {
        ...
        // Validate the UserEntity in the database
        var testUser = get("/api/users/{login}", updatedManagedUserVM.login).then().extract().body().as(UserEntity.class);
    ...
    public void updateUserExistingLogin() throws Exception {
        ...
        // Update the user
        UserEntity updatedUserEntity = get("/api/users/{login}", managedUserVM.login).then().extract().body().as(UserEntity.class);

        var updatedManagedUserVM = new ManagedUserVM();
        updatedManagedUserVM.id = updatedUserEntity.id;
        updatedManagedUserVM.login = otherManagedUserVM.login; // this login should already be used by anotherManagedUserVM
        updatedManagedUserVM.password = updatedUserEntity.password;
        updatedManagedUserVM.firstName = updatedUserEntity.firstName;
        updatedManagedUserVM.lastName = updatedUserEntity.lastName;
        updatedManagedUserVM.email = updatedUserEntity.email;
        updatedManagedUserVM.activated = updatedUserEntity.activated;
        updatedManagedUserVM.imageUrl = updatedUserEntity.imageUrl;
        updatedManagedUserVM.langKey = updatedUserEntity.langKey;
        updatedManagedUserVM.createdBy = updatedUserEntity.createdBy;
        updatedManagedUserVM.createdDate = updatedUserEntity.createdDate;
        updatedManagedUserVM.lastModifiedBy = updatedUserEntity.lastModifiedBy;
        updatedManagedUserVM.lastModifiedDate = updatedUserEntity.lastModifiedDate;
        updatedManagedUserVM.authorities = Set.of(AuthoritiesConstants.USER);
    ...
    public void testUserDTOtoUser() {
        ...
        assertThat(userEntity.login).isEqualTo(DEFAULT_LOGIN);
        assertThat(userEntity.firstName).isEqualTo(DEFAULT_FIRSTNAME);
        assertThat(userEntity.lastName).isEqualTo(DEFAULT_LASTNAME);
        assertThat(userEntity.email).isEqualTo(DEFAULT_EMAIL);
        assertThat(userEntity.activated).isEqualTo(true);
        assertThat(userEntity.imageUrl).isEqualTo(DEFAULT_IMAGEURL);
        assertThat(userEntity.langKey).isEqualTo(DEFAULT_LANGKEY);
        assertThat(userEntity.createdBy).isBlank();
        assertThat(userEntity.createdDate).isNotNull();
        assertThat(userEntity.lastModifiedBy).isBlank();
        assertThat(userEntity.lastModifiedDate).isNotNull();
        assertThat(userEntity.authorities).extracting("name").containsExactly(AuthoritiesConstants.USER);
    }
    ...
    public void testUserToUserDTO() {
        ...
        User userDTO = userMapper.userToUserDTO(user);
